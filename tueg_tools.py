...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default='./datasets/', help="The path to save the dataset to.")
    parser.add_argument("--url", default='https://www.isip.piconepress.com/projects/tuh_eeg/downloads/tuh_eeg_abnormal/',
                        help="The web address for the top directory of the data to be downloaded.")
    parser.add_argument("--username")
    parser.add_argument("--password")
    args = parser.parse_args()
    ds = Dataset(args.path)
    ds.download(args.url, username=args.username, password=args.password, maxSize=10**11)